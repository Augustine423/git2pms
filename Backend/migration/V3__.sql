...
(
    ...
    task_id      BIGINT                NULL,
    CONSTRAINT pk_componenttasks PRIMARY KEY (id)
);
...
ALTER TABLE component_tasks
    ADD CONSTRAINT FK_COMPONENTTASKS_ON_COMPONENT FOREIGN KEY (component_id) REFERENCES `component` (id);

ALTER TABLE component_tasks
    ADD CONSTRAINT FK_COMPONENTTASKS_ON_TASK FOREIGN KEY (task_id) REFERENCES task (id);
