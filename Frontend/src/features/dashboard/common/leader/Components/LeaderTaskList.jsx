...
import { FaClipboardList } from "react-icons/fa"; // You can change this icon to match your style
import { FaDotCircle } from "react-icons/fa";
import { ChevronDown, ChevronUp } from "lucide-react";
import { Link } from 'react-router-dom';

const LeaderTaskList = ({ title, links, handleSelectItem, isOpen, toggleMenu, expandedMenus }) => {
  return (
    <div className="w-full">
      <button
        onClick={() => toggleMenu("leaderTask")}
