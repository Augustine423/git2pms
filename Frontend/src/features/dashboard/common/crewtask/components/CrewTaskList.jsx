  ...
  return (
    <div className="w-full">
      <button
        ...
        className="w-full flex items-center justify-between p-2 text-black bg-white focus:bg-green-500 rounded-md"
      >
        ...
        <div className="mt-1 space-y-1 w-full text-white">
          {links.map((link, index) => (
            <div key={index} className="ml-9 mt-1 space-y-1">
              <Link
                to={link.path}
                className="py-2 px-2 pl-5 text-black hover:text-white hover:bg-green-500 focus:bg-green-500  rounded-md w-full mb-2 flex justify-start items-center"
